...
public class LocalizerThreeDeadWheelsImu extends LocalizerComponent {

    static  final public String sTypeKey        = "3-dead-wheels-imu";
    ...
    public  LocalizerThreeDeadWheelsImu(String name, HardwareMap hwMap, Map<String, MotorComponent> motors, Map<String, ImuComponent> imus, LogManager logger) {
    ...
    public void                         read(JSONObject reader) {
        ...
        try {
            ...
            if(reader.has(sImuHwMapKey)) {
                ...
                if(mImus.containsKey(mImuHwMapName)) {
                    mImu = mImus.get(mImuHwMapName);
                }
            }
